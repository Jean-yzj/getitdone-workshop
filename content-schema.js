...
export const CONTENT_SCHEMA = [
  ...
  { section: '表單欄位文字', key: 'form_q13_label', label: '欄位 · 年級', kind: 'text', default: '你目前的階段是？' },
  { section: '表單欄位文字', key: 'form_q13_help', label: '欄位 · 年級說明', kind: 'text', default: '請選一個最符合你目前狀態的選項。' },
  { section: '表單欄位文字', key: 'form_q14_label', label: '欄位 · 科系或產業領域', kind: 'text', default: '你的科系或產業領域是什麼？' },
  { section: '表單欄位文字', key: 'form_q14_help', label: '欄位 · 科系或產業領域說明', kind: 'text', default: '例如：資工、心理、行銷、產品、設計、財務、教育等。' },
  { section: '表單欄位文字', key: 'form_q14_ph', label: '欄位 · 科系或產業領域 placeholder', kind: 'text', default: '請填寫你的科系或產業領域' },
