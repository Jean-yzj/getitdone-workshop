...
export const CONTENT_SCHEMA = [
  ...
  { section: '表單欄位文字', key: 'form_q13_label', label: '欄位 · 目前階段', kind: 'text', default: '你目前所處的階段是什麼？' },
  { section: '表單欄位文字', key: 'form_q13_help', label: '欄位 · 目前階段說明', kind: 'text', default: '例如：大學生、研究生、求職中、轉職中、剛創業、自由工作者。' },
  { section: '表單欄位文字', key: 'form_q13_ph', label: '欄位 · 目前階段 placeholder', kind: 'text', default: '例如：大四應屆、第一份工作、轉職探索期、正在做 side project' },
